...
namespace VisionCore
{
    public class Log
    {
        ...
        /// <summary> 模块参数修改记录 </summary>
        private static readonly ILog LogModify = LogManager.GetLogger("modifyLogger");

        /// <summary> 显示Log字符串的委托 </summary>
        public static Action<LogLevel, string> OnShowString { get; set; }
        ...
        public static void InitializeRichTextBox(Action<LogActionEnum, string> RichTextBoxLog)
        {
        ...
        private static void ShowString(LogLevel _level, string str)
        {
            OnShowString?.BeginInvoke(_level, str, null, null);
        }

        /// <summary>记录模块参数变更记录  用于记录额外的一些重要记录,比如关键参数修改记录-->记录在log/modify文件下</summary>
        public static void ModParamModify(string str)
        {
            ShowString(LogLevel.Info, str);
            LogModify.Info(str);
        }
        /// <summary>调试</summary>
        public static void Debug(string str)
        {
            ShowString(LogLevel.Debug, str);
            log4Net.Debug(str);
        }
        /// <summary>提示</summary>
        ...
        internal static void Comm(string str)
        {
            ShowString(LogLevel.Comm, str);
            log4Net.Info(str);
        }
        /// <summary>警告</summary>
        public static void Warn(string str)
        {
            ShowString(LogLevel.Warn, str);
            log4Net.Warn(str);
        }
        /// <summary>错误</summary>
        public static void Error(string str) // error为关键字
        {
            ShowString(LogLevel.Error, str);
            log4Net.Error(str);
        }
        /// <summary>异常</summary>
        public static void Fatal(Exception ex)
        {
            ShowString(LogLevel.Fatal, ex.Message + Environment.NewLine + ex.StackTrace);
            log4Net.Fatal(ex.Message + Environment.NewLine + ex.StackTrace);
        }
        /// <summary>打印</summary>
