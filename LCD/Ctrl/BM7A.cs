...
namespace LCD.Ctrl
{
    ...
    public class BM7A : TestMachine//serialPort.SendStr("ST" + sLineBreak);
    {
        ...
        public override void Init()
        {
            ...
            serialPort.BaudRate = Project.cfg.BM7A.bardRateText;
            serialPort.DataBits = Project.cfg.BM7A.dataBitText;
            serialPort.Parity = Project.cfg.BM7A.parityText;
