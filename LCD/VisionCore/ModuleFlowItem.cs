...
namespace VisionCore
{
    ...
    public class ModFlowItem : TreeNode
    {
        ...
        private static Dictionary<string, byte[]> mImageIconDic;
        ...
        //    {
        //        var icon = PluginToolService.mPluginDic[ident].IconImage;
        //        if (icon != null)
        //        {
        ...
        public ModFlowItem(ModInfo info, int index) : base(info.Name)
        {
            ...
            if (mImageIconDic == null)
            {
                ...
                mImageIconDic = new Dictionary<string, byte[]>();
            }
                        ...
                        switch (UnitType)
                        {
                            case UnitType.Mod:
                                ...
                                if (mModInfo.Name.Length > 0)
                                {
                                    ...
                                    if (mImageIconDic.ContainsKey(mModInfo.Plugin))
                                    {
                                        //byte[] image2 = mImageIconDic[mModInfo.Plugin];
                                        ////-------------------依据判定结果获取图标 
