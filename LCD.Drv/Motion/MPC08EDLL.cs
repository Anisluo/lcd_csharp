...
namespace LCD.Dll
{
    public class MPC08EDLL
    {
        ...
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 set_outmode(Int32 ch,
            Int32 mode,
            Int32 logic);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 set_org_logic(Int32 ch,
            Int32 flag);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 enable_card_alm(Int32 cardno, 
            Int32 flag);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 set_card_alm_logic(Int32 cardno,
            Int32 mode);
        ...
        /// <returns>0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern int set_vector_profile(double vl, double vh, double vec_ad);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 con_line2(Int32 ch1, Int32 step1, Int32 ch2, Int32 step2);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 fast_line2(Int32 ch1, Int32 step1, Int32 ch2, Int32 step2);
        ...
        /// <returns> 0（正确）-----  -1（错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 fast_line3(Int32 ch1, long step1, Int32 ch2, long step2, Int32 ch3, long step3);
        ...
        /// <returns> 0（成功）-----  -1（错误） </returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 get_abs_pos(Int32 ch, ref long pos);
        ...
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 write_password_flash(Int32 cardno,
            Int32 no,
            Int32 data,
            Int32 password);
        ...
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 read_password_flash(Int32 cardno,
            Int32 no,
            ref Int32 data,
            Int32 password);
        ...
        /// <returns> 0（无效）-----  -1（参数错误）---- -2（校验密码出错）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 clear_password_flash(Int32 cardno,
            Int32 password);
        ...
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 write_flash(Int32 cardno,
            Int32 piece,
            Int32 no,
            Int32 data);
        ...
        /// <returns> 0（无效）-----  -1（参数错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 read_flash(Int32 cardno,
            Int32 piece,
            Int32 no, 
            ref Int32 data);
        ...
        /// <returns> 0（无效）-----  -1（参数错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 clear_flash(Int32 cardno, 
            Int32 piece);
        ...
        /// <returns> 0（无效）-----  -1（参数错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 get_lib_ver(ref Int32 major,
            ref Int32 minor1,
            ref Int32 minor2);
        ...
        /// <returns> 0（无效）-----  -1（参数错误）</returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 get_sys_ver(ref Int32 major,
            ref Int32 minor1,
            ref Int32 minor2);
        ...
        /// <returns></returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 get_card_ver(Int32 carno,
            ref Int32 type,
            ref Int32 major,
            ref Int32 minor1,
            ref Int32 minor2);
        ...
        /// <returns></returns>
        [DllImport(@"MPC08.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 GetDllInfo(Int32 InfoNum,
            ref Int32 rtn);
        ////////////////////////////////////////////////////////////////////////
    }
}
